...
The Arrhythmia dataset is a table witch each row it is collection of health measurement for each patience and the last one says if this persons it is a normal health or has some of the 15 arrhythmia.


```{r Overview Characteristics of dataset}
# dimension
dim(arrhythmia.uci)

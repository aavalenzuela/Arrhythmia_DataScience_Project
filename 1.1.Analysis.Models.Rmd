...
These predictor are present in the tree too, not all of them because the tree shows less than 20 predictors, and the overall it is not directly related with the order in the decision tree. Now see how well it is the prediction in the validation set:
...
In 5 classes we can not predict any case (Sensitivity =0 & Specificity=1) and Class 9 we have all the cases rigth!
...
The values that get the better result are `r fit_svm$bestTune`.

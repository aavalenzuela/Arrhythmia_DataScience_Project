...
Pred2_results <- data.frame(Model = "Just the most common",
                            Accuracy = cm$overall["Accuracy"],
                            Class.1.Code = row.names(cm$byClass)[1],
                            Class.1.Sensitivity = cm$byClass[1,1],
                            Class.1.Specificity = cm$byClass[1,2],
                            Class.2.Code = row.names(cm$byClass)[2],
                            Class.2.Sensitivity = cm$byClass[2,1],
                            Class.2.Specificity = cm$byClass[2,2],
                            Class.3.Code = row.names(cm$byClass)[3],
                            Class.3.Sensitivity = cm$byClass[3,1],
                            Class.3.Specificity = cm$byClass[3,2],
                            Class.4.Code = row.names(cm$byClass)[4],
                            Class.4.Sensitivity = cm$byClass[4,1],
                            Class.4.Specificity = cm$byClass[4,2],
                            Class.5.Code = row.names(cm$byClass)[5],
                            Class.5.Sensitivity = cm$byClass[5,1],
                            Class.5.Specificity = cm$byClass[5,2],
                            Class.6.Code = row.names(cm$byClass)[6],
                            Class.6.Sensitivity = cm$byClass[6,1],
                            Class.6.Specificity = cm$byClass[6,2],
                            Class.7.Code = row.names(cm$byClass)[7],
                            Class.7.Sensitivity = cm$byClass[7,1],
                            Class.7.Specificity = cm$byClass[7,2],
                            Class.8.Code = row.names(cm$byClass)[8],
                            Class.8.Sensitivity = cm$byClass[8,1],
                            Class.8.Specificity = cm$byClass[8,2],
                            Class.9.Code = row.names(cm$byClass)[9],
                            Class.9.Sensitivity = cm$byClass[9,1],
                            Class.9.Specificity = cm$byClass[9,2],
                            Class.10.Code = row.names(cm$byClass)[10],
                            Class.10.Sensitivity = cm$byClass[10,1],
                            Class.10.Specificity = cm$byClass[10,2],
                            Class.11.Code = row.names(cm$byClass)[11],
                            Class.11.Sensitivity = cm$byClass[11,1],
                            Class.11.Specificity = cm$byClass[11,2],
                            Class.12.Code = row.names(cm$byClass)[12],
                            Class.12.Sensitivity = cm$byClass[12,1],
                            Class.12.Specificity = cm$byClass[12,2],
                            row.names = NULL)
Pred2_results[,1:8] %>% knitr::kable(caption = "Prediction All Arrhytmia Classification Summary")
...
KNN has a very poor sensitivity and very good specificity. If "Arrhythmia" es predicted we have a good chance to be correct, but if we predict "Normal" we have a good chance to be wrong! We need to improve sensitivity.
...
### Second Predictions
Let's works with the second Prediction
```{r rpart Model Second Prediction train, echo=FALSE, warning=FALSE}
...
```{r rpart Model Second Prediction Predict, echo=FALSE, warning=FALSE}
# compute accuracy
...
```{r rpart Model Second Prediction Prune, echo=FALSE, warning=FALSE}
# prune the tree 
#library(rpart)
...
For our record, we keep this result:
```{r rpart Model Second Prediction Result, echo=FALSE}
Pred2_results <- bind_rows(Pred2_results,
...
```{r SVM Model Second Prediction train, echo=FALSE, warning=FALSE}
...
options(digits =2)
cm <- confusionMatrix(data = svcpred, reference = validation_set1$`Class code`) #$overall["Accuracy"]
cm
options(digits =7) # default
```

For our record, we keep this result:
```{r SVM Model Second Prediction Result, echo=FALSE}
Pred2_results <- bind_rows(Pred2_results,
